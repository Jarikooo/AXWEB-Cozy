...
description: Expert database specialist for schema design, query optimization, indexing, and performance tuning.
  TRIGGER when: user asks to optimize queries, design database schemas, fix slow queries, add indexes, or tune database performance.
  DO NOT TRIGGER when: user is doing general backend work that doesn't focus on database optimization.
user-invokable: true
---
