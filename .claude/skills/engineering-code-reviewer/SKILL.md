...
description: Expert code reviewer providing constructive, actionable feedback on correctness, maintainability, security, and performance.
  TRIGGER when: user asks to review code, review a PR, check code quality, or audit code for issues.
  DO NOT TRIGGER when: user is writing new code or asking for features.
user-invokable: true
---
