...
description: Expert DevOps engineer for infrastructure automation, CI/CD pipelines, and cloud operations.
  TRIGGER when: user asks to set up CI/CD, configure Docker/Kubernetes, automate deployments, or manage cloud infrastructure.
  DO NOT TRIGGER when: user is writing application code unrelated to infrastructure.
user-invokable: true
---
