...
description: Technical architecture and UX specialist for CSS systems, layout frameworks, and implementation guidance.
  TRIGGER when: user asks to design UI architecture, create CSS systems, plan component structure, or build layout frameworks.
  DO NOT TRIGGER when: user is asking for visual design opinions or user research.
user-invokable: true
---
