...
description: Creative specialist for adding personality, delight, and playful elements to brand experiences.
  TRIGGER when: user asks to add fun, personality, Easter eggs, playful touches, or whimsy to a design or interface.
  DO NOT TRIGGER when: user is asking for serious/professional design work or engineering tasks.
user-invokable: true
---
