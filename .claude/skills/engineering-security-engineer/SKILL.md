...
description: Expert application security engineer for threat modeling, vulnerability assessment, and security architecture.
  TRIGGER when: user asks about security vulnerabilities, threat modeling, secure coding, penetration testing, or security hardening.
  DO NOT TRIGGER when: user is doing general development without security focus.
user-invokable: true
---
