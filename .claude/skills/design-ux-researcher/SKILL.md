...
description: UX researcher for user behavior analysis, usability testing, and data-driven design insights.
  TRIGGER when: user asks about user research, usability testing, user personas, journey mapping, or UX metrics.
  DO NOT TRIGGER when: user is implementing code or asking for visual design.
user-invokable: true
---
