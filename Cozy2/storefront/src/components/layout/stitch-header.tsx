...
export function StitchHeader() {
    ...
    return (
        <>
            ...
            <div
                ref={menuRef}
                className="fixed top-0 left-0 h-[100dvh] w-full max-w-[420px] bg-background-light border-r border-[#18181b] z-[201] flex flex-col -translate-x-full overflow-hidden"
            >
                {/* Menu Header — close button on the right */}
                <div className="flex items-center justify-between px-6 pt-4 pb-4 border-b border-[#18181b]">
                ...
                {/* Menu Content — no scrollbar */}
                <div className="flex-1 px-6 py-6 flex flex-col items-stretch w-full">
                    {/* Primary Nav Links */}
                    <Link onClick={() => setIsMenuOpen(false)} href="/shop" className="group py-4 border-b border-[#18181b] flex items-center justify-between w-full">
                    ...
                    {categories.map((cat) => (
                        <div key={cat.id} className="border-b border-[#18181b] flex flex-col w-full">
                            <div className="group flex justify-between items-center w-full py-4">
                            ...
                            {openSubcategories[cat.id] && cat.subcategories && cat.subcategories.length > 0 && (
                                <div className="flex flex-col pb-4 pl-4 space-y-1 border-t border-[#18181b]/10 pt-3">
                    ...
                    <div className="mt-8 flex flex-col gap-1">
                        <p className="text-[10px] font-bold uppercase tracking-widest text-[#18181b]/30 mb-2">Meer</p>
                        <Link onClick={() => setIsMenuOpen(false)} href="/over-ons" className="group flex items-center gap-3 py-2.5">
                        ...
                        <Link onClick={() => setIsMenuOpen(false)} href="/contact" className="group flex items-center gap-3 py-2.5">
